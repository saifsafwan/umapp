...
<div class="flex flex-col break-words bg-white border-2 rounded shadow-md">
    ...
    <form class="w-full p-6" method="POST" action="{{ route('register') }}">
        ...
        <div class="flex flex-wrap mb-6">
            ...
            <select name="user_type" id="usertype" class="form-select block w-full" required autofocus>
                <option value="accountant">Faculty Accountant</option>
                <option value="dean">Faculty Deans</option>
                <option value="bursary">Bursary Officers</option>
            </select>
        ...
        <div class="flex flex-wrap mb-6">
            ...
            <input id="name" type="text" class="form-input w-full @error('name')  border-red-500 @enderror" name="name" value="{{ old('name') }}" required autocomplete="name">
